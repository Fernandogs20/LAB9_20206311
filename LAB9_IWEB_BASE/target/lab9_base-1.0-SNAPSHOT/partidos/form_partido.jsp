            ...
            <form method="POST" action="<%=request.getContextPath()%>/PartidoServlet?action=guardar">
                ...
                <div class="form-group">
                    ...
                    <select name="arbitro" class="form-control" required>
                        ...
                        %>
                        <option value="<%= arbitro.getIdArbitro() %>"><%= arbitro.getNombre() %> - <%= arbitro.getPais() %></option>
                        <%
                                }
                            }
                        %>
                ...
                <a href="<%=request.getContextPath()%>/PartidoServlet" class="btn btn-danger" onclick="return confirm('¿Está seguro de que desea cancelar?')">Cancelar</a>
            </form>
        </div>
        <div class="col"></div>
    </div>
